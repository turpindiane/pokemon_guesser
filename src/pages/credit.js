  ...
  return (
    <Layout>
      <div className={Styles.creditText}>
        <img src="https://www.serebii.net/scarletviolet/pokemon/new/025-o.png" />
        <br /> <br />
        ...
        />
        <br /> <br />
        Copyright to The Pokémon Company for all Pokémon images.
        <br /> <br />
        Thank you to{" "}
        <a href="https://www.flaticon.com/authors/riajulislam">flaticon</a> for
